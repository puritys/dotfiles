...
let s:comment_gui = $ConstColorHexFgComment
let s:overlay_gui = $ConstColorHexBgOverlay

let s:nord0_gui = $ConstColorHexBgLevel1
let s:nord1_gui = $ConstColorHexBgLevel2
let s:nord2_gui = $ConstColorHexBgLevel3
let s:nord3_gui = $ConstColorHexBgLevel4
let s:nord3_gui_bright = $ConstColorHexFgLevel0
let s:nord4_gui = $ConstColorHexFgLevel1
let s:nord5_gui = $ConstColorHexFgLevel2
let s:nord6_gui = $ConstColorHexFgLevel3
let s:nord7_gui = $ConstColorHexFgSelLevel4
let s:nord8_gui = $ConstColorHexFgSelLevel3
let s:nord9_gui = $ConstColorHexFgSelLevel2
let s:nord10_gui = $ConstColorHexFgSelLevel1
let s:nord11_gui = $ConstColorHexC1
let s:nord12_gui = $ConstColorHexC2
let s:nord13_gui = $ConstColorHexC3
let s:nord14_gui = $ConstColorHexC4
let s:nord15_gui = $ConstColorHexC5
...
call s:hi("CursorLine", "", s:overlay_gui, "NONE", s:nord1_term, "NONE", "")
...
call s:hi("Normal", s:nord4_gui, s:nord1_gui, "NONE", "NONE", "", "")
...
call s:hi("Visual", "", s:nord0_gui, "", s:nord1_term, "", "")
...
call s:hi("Folded", s:nord3_gui_bright, s:nord1_gui, s:nord3_term, s:nord1_term, s:bold, "")
...
"+--- Tabs ---+
call s:hi("TabLine", s:nord3_gui_bright, s:nord1_gui, "NONE", s:nord1_term, "NONE", "")
call s:hi("TabLineFill", s:nord4_gui, s:nord1_gui, "NONE", s:nord1_term, "NONE", "")
call s:hi("TabLineSel", s:nord1_gui, s:nord9_gui, s:nord8_term, s:nord3_term, "NONE", "")

"+--- Window ---+
call s:hi("Title", s:nord4_gui, "", "NONE", "", "NONE", "")

if g:nord_bold_vertical_split_line == 0
  call s:hi("VertSplit", s:nord3_gui_bright, s:nord0_gui, s:nord3_term, "NONE", "NONE", "")
else
  call s:hi("VertSplit", s:nord3_gui_bright, s:nord1_gui, s:nord3_term, s:nord1_term, "NONE", "")
endif
...
call s:hi("Comment", s:comment_gui, "", s:nord3_term, "", s:italicize_comments, "")
call s:hi("Conceal", s:nord3_gui_bright, "NONE", "", "NONE", "", "")
...
call s:hi("CocWarningHighlight" , "", "", "", "", "none", "")
call s:hi("CocErrorHighlight" , "", "", "", "", "none", "")
call s:hi("DiagnosticUnderlineError" , "", "", "", "", "none", "")
call s:hi("DiagnosticUnderlineWarn" , "", "", "", "", "none", "")
call s:hi("DiagnosticUnderlineInfo" , "", "", "", "", "none", "")
call s:hi("DiagnosticUnderlineHint" , "", "", "", "", "none", "")
...
call s:hi("CocErrorFloat", s:nord11_gui, s:nord4_gui, "", s:nord11_term, "", "")
