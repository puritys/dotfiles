...
" Which one is right?
let g:colors_name = "mystyle_black_nice"



hi Normal   ctermfg=248 ctermbg=236 gui=none  guifg=#d0d0d0   guibg=#202020
hi LineNr   cterm=none  ctermfg=248 ctermbg=236 gui=none    guifg=#a8a8a8

hi IncSearch    cterm=none  ctermfg=251   ctermbg=223 gui=none    guifg=#000000   guibg=#ffdfaf


hi Search   cterm=none  ctermfg=251  ctermbg=87  gui=none    guifg=#000000   guibg=#afdf5f
...
hi FoldColumn   cterm=none  ctermfg=251 ctermbg=234  gui=none    guifg=#a8a8a8   guibg=bg
...
"  "xxxxxx" COLD
hi Constant cterm=none  ctermfg=191  ctermbg=236 gui=none guifg=#dfdfaf   guibg=bg
...
" = ->   $aa->
hi Statement    cterm=none  ctermfg=160  ctermbg=bg  gui=none    guifg=#5fafdf   guibg=bg
